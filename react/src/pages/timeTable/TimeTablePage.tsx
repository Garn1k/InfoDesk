    ...
    <div className='timeTable'>
      ...
      <div className='main_1'>
        ...
        {add ? <div className='form'>
          ...
          <div>
            <div>
              <h3 className='h3-1'>ԱԶԳԱՅԻՆ ԺՈՂՈՎԻ ՄՇՏԱԿԱՆ ՀԱՆՁՆԱԺՈՂՈՎՆԵՐԻ ԿՈՂՄԻՑ ԿԱԶՄԱԿԵՐՊՎՈՂ ՔԱՂԱՔԱՑԻՆԵՐԻ ԸՆԴՈՒՆԵԼՈՒԹՅՈՒՆՆԵՐԻ ԺԱՄԱՆԱԿԱՑՈՒՅՑ</h3>
              <table >
                <thead>
                  <tr>
                    <th>Հանձնաժողովի անվանումը</th>
                    <th>Օրը</th>
                    <th>Ժամը</th>
                  </tr>
                </thead>
            ...
            <div>
              <h3 className='h3-2'>ԱԶԳԱՅԻՆ ԺՈՂՈՎԻ ՆԱԽԱԳԱՀԻ ՏԵՂԱԿԱԼՆԵՐԻ ԿՈՂՄԻՑ ԿԱԶՄԱԿԵՐՊՎՈՂ ՔԱՂԱՔԱՑԻՆԵՐԻ ԸՆԴՈՒՆԵԼՈՒԹՅՈՒՆՆԵՐԻ ԺԱՄԱՆԱԿԱՑՈՒՅՑ</h3>
